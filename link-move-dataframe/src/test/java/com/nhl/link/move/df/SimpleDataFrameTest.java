...
public class SimpleDataFrameTest {
    ...
    public void testForEach() {
        ...
        new SimpleDataFrame(columns, rows).forEach(consumed::add);
    ...
    public void testHead() {
        ...
        new SimpleDataFrame(columns, rows).head(3).forEach(consumed::add);
    ...
    public void testRenameColumn() {
        ...
        DataFrame df = new SimpleDataFrame(columns, rows).renameColumn("b", "c");
    ...
    public void testConvertColumn() {
        ...
        DataFrame df = new SimpleDataFrame(columns, rows).convertType("b", String.class, Object::toString);
