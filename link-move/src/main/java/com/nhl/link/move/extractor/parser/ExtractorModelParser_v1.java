...
public class ExtractorModelParser_v1 implements DOMExtractorModelParser {
    ...
    protected void doParse(MutableExtractorModelContainer container, Element rootElement) throws DOMException {
    ...
    protected void processAttribute(Element attributeNode, List<RowAttribute> attributes) throws DOMException {
