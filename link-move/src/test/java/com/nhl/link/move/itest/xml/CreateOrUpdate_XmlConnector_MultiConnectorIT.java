...
public class CreateOrUpdate_XmlConnector_MultiConnectorIT extends LmIntegrationTest {
    ...
    protected LmRuntimeBuilder testRuntimeBuilder() {
        URL f1 = getClass().getResource("f1.xml");
        URL f2 = getClass().getResource("f2.xml");
        return super.testRuntimeBuilder()
                .connector(StreamConnector.class, "f1.xml", URLConnector.of(f1))
                .connector(StreamConnector.class, "f2.xml", URLConnector.of(f2));
    }
