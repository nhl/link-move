 ...
 */
public abstract class _Etl6t extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Etl6t> SELF = PropertyFactory.createSelf(Etl6t.class);

    public static final NumericIdProperty<Long> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "Etl6t", Long.class);
