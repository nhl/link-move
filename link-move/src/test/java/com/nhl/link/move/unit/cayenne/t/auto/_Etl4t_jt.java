 ...
 */
public abstract class _Etl4t_jt extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Etl4t_jt> SELF = PropertyFactory.createSelf(Etl4t_jt.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "Etl4t_jt", Integer.class);
