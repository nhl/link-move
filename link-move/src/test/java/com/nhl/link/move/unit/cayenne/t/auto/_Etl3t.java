 ...
 */
public abstract class _Etl3t extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Etl3t> SELF = PropertyFactory.createSelf(Etl3t.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "Etl3t", Integer.class);
    ...
    public static final EntityProperty<Etl2t> E2 = PropertyFactory.createEntity("e2", Etl2t.class);
    public static final EntityProperty<Etl5t> E5 = PropertyFactory.createEntity("e5", Etl5t.class);
