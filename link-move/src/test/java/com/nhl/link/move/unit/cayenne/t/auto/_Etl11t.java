 ...
 */
public abstract class _Etl11t extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Etl11t> SELF = PropertyFactory.createSelf(Etl11t.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "Etl11t", Integer.class);
