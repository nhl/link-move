 ...
 */
public abstract class _Etl12t extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Etl12t> SELF = PropertyFactory.createSelf(Etl12t.class);

    public static final NumericIdProperty<Integer> MIXED_CASE_ID_PK_PROPERTY = PropertyFactory.createNumericId("MixedCaseId", "Etl12t", Integer.class);
