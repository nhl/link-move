 ...
 */
public abstract class _Etl7t extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Etl7t> SELF = PropertyFactory.createSelf(Etl7t.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "Etl7t", Integer.class);
