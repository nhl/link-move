 ...
 */
public abstract class _Etl1t extends PersistentObject {

    private static final long serialVersionUID = 1L;

    public static final SelfProperty<Etl1t> SELF = PropertyFactory.createSelf(Etl1t.class);

    public static final NumericIdProperty<Integer> ID_PK_PROPERTY = PropertyFactory.createNumericId("id", "Etl1t", Integer.class);
