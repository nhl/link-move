...
import com.nhl.link.framework.etl.keybuilder.KeyBuilderFactory;
import com.nhl.link.framework.etl.runtime.cayenne.ITargetCayenneService;
import com.nhl.link.framework.etl.runtime.cayenne.TargetCayenneService;
import com.nhl.link.framework.etl.runtime.connect.ConnectorService;
import com.nhl.link.framework.etl.runtime.connect.IConnectorFactory;
import com.nhl.link.framework.etl.runtime.connect.IConnectorService;
import com.nhl.link.framework.etl.runtime.extract.ClasspathExtractorConfigLoader;
import com.nhl.link.framework.etl.runtime.extract.ExtractorService;
import com.nhl.link.framework.etl.runtime.extract.IExtractorConfigLoader;
import com.nhl.link.framework.etl.runtime.extract.IExtractorFactory;
...
import com.nhl.link.framework.etl.runtime.task.TaskService;
import com.nhl.link.framework.etl.runtime.token.ITokenManager;
import com.nhl.link.framework.etl.runtime.token.InMemoryTokenManager;
...
public class EtlRuntimeBuilder {
	...
	public static final String CONNECTORS_MAP = "com.nhl.link.framework.etl.connectors";
	public static final String CONNECTOR_FACTORIES_MAP = "com.nhl.link.framework.etl.connector.factories";
	public static final String EXTRACTOR_FACTORIES_MAP = "com.nhl.link.framework.etl.extractor.factories";
