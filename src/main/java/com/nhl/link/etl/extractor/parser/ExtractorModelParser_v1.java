...
import com.nhl.link.etl.extractor.model.ContainerAwareExtractorModel;
...
import com.nhl.link.etl.extractor.model.MutableExtractorModelContainer;
...
public class ExtractorModelParser_v1 implements DOMExtractorModelParser {
	...
	protected void doParse(MutableExtractorModelContainer container, Element rootElement)
		...
		// v.1 - reusing location as name
		String name = container.getLocation();

		MutableExtractorModel extractor = new MutableExtractorModel(name);
		doParse(rootElement, container, extractor);
		container.addExtractor(name, new ContainerAwareExtractorModel(container, extractor));
	}
