...
import com.nhl.link.etl.runtime.task.DefaultTaskBuilder;
...
public class MatchingTaskBuilderTest {
	...
	public void testTask_NoExtractorName() {
		DefaultTaskBuilder<Etl1t> builder = new DefaultTaskBuilder<>(Etl1t.class, mock(ITargetCayenneService.class),
